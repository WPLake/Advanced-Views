...
namespace Org\Wplake\Advanced_Views\Post_Type\Layouts\Integration\Gutenberg;
...
final class Layout_Gutenberg_Block extends Hookable implements Hooks_Interface {
	...
	public function enqueue_editor_assets(): void {
		wp_enqueue_script(
			self::NAME,
			$this->plugin->get_assets_url( 'js/admin/post-type/layouts/gutenberg/layout-gutenberg.min.js' ),
